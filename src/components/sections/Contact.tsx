  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const templateParams = {
        ...
        from_mobile: formData.mobile || 'Not provided',
        message: formData.message,
        to_email: 'fatihabrar@gmail.com' // Your email where you want to receive messages
      };
    ...
    <section id="contact" className="min-h-screen bg-black flex items-center justify-center p-3 sm:p-4 md:p-6 lg:p-8">
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 items-center">
        ...
        <div className="relative lg:-mt-24 order-1 lg:order-1">
          ...
          <div className="mt-6 lg:mt-20 flex flex-col sm:flex-row gap-2 sm:gap-3 lg:gap-4 items-center justify-center lg:justify-start">
            <a
              href="https://www.instagram.com/mv.fath/"
              target="_blank"
            ...
            >
              <svg className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5" fill="white" viewBox="0 0 24 24">
            ...
            <a
              href="mailto:fatihabrar@gmail.com"
              className="flex items-center justify-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 lg:px-5 lg:py-3 border-2 border-gray-700 hover:border-lime-400 hover:bg-lime-400 hover:text-black transition-all duration-200 group w-full sm:w-auto"
              style={{
                fontSize: 'clamp(0.625rem, 2vw, 0.75rem)'
              }}
            ...
            <a
              href="https://www.linkedin.com/in/fatihabrar/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 sm:gap-3 px-3 sm:px-4 py-2 lg:px-5 lg:py-3 border-2 border-gray-700 hover:border-lime-400 hover:bg-lime-400 hover:text-black transition-all duration-200 group w-full sm:w-auto"
              style={{
            ...
            >
              <svg className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-gray-300 group-hover:text-black" fill="white" viewBox="0 0 24 24">
